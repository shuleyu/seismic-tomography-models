...
// the downloaded files are converted into "LLNL-G3Dv3_vp.txt";
...
int main(){
    ...
    string tmpstr;
    ifstream fpin("LLNL-G3Dv3_vp.txt");

    while (fpin >> depth >> lat >> lon >> vp){
    ...
    // write nc file.
    int retval,ncid;
    string outfile="LLNL-G3Dv3_vp.nc";
